...
const sections = [
  {id: "in-the-afterlife", title: "In The Afterlife"},
  {id: "the-pantheon", title: "The Pantheon"},
  {
    id: "going-west-after-uncle-arts-funeral",
    title: "Going West After Uncle Art's Funeral",
  },
  {
    id: "when-all-youve-got-is-a-hammer",
    title: "When All You've Got is a Hammer",
  },
  // Add all your sections here
];
export default function WJoeHoppe() {
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-16 pt-4 md:pt-8 max-w-3xl">
      <ScrollSpy sections={sections} />
      <section id="in-the-afterlife" className="scroll-mt-24 mb-16">
        <h1>In The Afterlife, Fidel Castro Dances With Florence Henderson</h1>
        <h3>by W. Joe Hoppe</h3>
        <p>
          And the dancefloor is like an ice rink
          <br />
          they glide in and out of billowing clouds <br />
          ...
          <br />
          <em>
            From 11-26-16, when Cuban Dictator Castro and Ms. Henderson, who
            starred as the mom on 70s TV series “The Brady Bunch” both died on
            the same day
          </em>
        </p>
      </section>
      <section id="the-pantheon" className="scroll-mt-24 mb-16">
        <h1>The Pantheon</h1>
        <h3>by W. Joe Hoppe</h3>
        <em>Rome, 12/26/2018</em>
        <p>
      ...
      <section
        ...
        <h1>Going West After Uncle Art&apos;s Funeral</h1>
        <h3>by W. Joe Hoppe</h3>
        <p>
          ...
          <br />a song that no one has ever played like this.
        </p>
      </section>
      <section
        id="when-all-youve-got-is-a-hammer"
        className="scroll-mt-24 mb-16">
        <h1>When All You&apos;ve Got is a Hammer</h1>
        <h3>by W. Joe Hoppe</h3>
        <p>
